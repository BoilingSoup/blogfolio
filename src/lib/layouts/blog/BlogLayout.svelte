...
<main>
  <div
    class="mx-auto mt-8 rounded-md bg-slate-300 text-xl leading-10 tracking-wide transition ease-in-out lg:container dark:bg-zinc-900 dark:text-white md:text-2xl md:tracking-wider"
  >
    <article
